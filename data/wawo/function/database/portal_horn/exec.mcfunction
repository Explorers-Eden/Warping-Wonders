scoreboard players add $total_players wawo.portal_horn.player.id 1
execute store result storage eden:temp portal_horn.id int 1 run scoreboard players operation @s wawo.portal_horn.player.id = $total_players wawo.portal_horn.player.id
