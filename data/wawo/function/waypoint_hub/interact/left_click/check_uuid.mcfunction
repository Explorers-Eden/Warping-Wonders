...
execute if items entity @s weapon.mainhand minecraft:music_disc_5[minecraft:custom_data={warping_wonders:{item:"totem_of_homecoming"}}] run return run function wawo:waypoint_hub/interact/totem_of_homecoming with storage eden:temp waypoint.head
