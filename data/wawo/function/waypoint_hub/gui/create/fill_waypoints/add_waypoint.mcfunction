...
$execute unless data storage eden:database waypoints.hubs.$(waypoint_id){access:"private"} run \
    item modify block ~ ~ ~ container.$(slot) [\
        ...
        {"function":"minecraft:set_lore","entity":"this","lore":[\
            ...
            [{"translate":"gui.warping_wonders.waypoint_hub.dimension","color":"dark_gray","bold":false,"italic":false},{"nbt":"waypoints.hubs.$(waypoint_id).dimension_name","storage":"eden:database","color":"white","bold":false,"italic":false}],\
            [{"translate":"gui.warping_wonders.waypoint_hub.access","color":"dark_gray","bold":false,"italic":false},{"translate":"gui.warping_wonders.waypoint_hub.public","color":"green","bold":false,"italic":false}],\
            [{"text":"  "}],\
            [{"translate":"gui.warping_wonders.waypoint_hub.owner","color":"dark_gray","bold":false,"italic":false},{"nbt":"waypoints.hubs.$(waypoint_id).profile.name","storage":"eden:database","color":"white","bold":false,"italic":false},{"text":" | ID: ","color":"dark_gray","bold":false,"italic":false},{"nbt":"waypoints.hubs.$(waypoint_id).id","storage":"eden:database","color":"white","bold":false,"italic":false}],\
                ],"mode":"replace_all"}]
...
$execute unless data storage eden:database waypoints.hubs.$(waypoint_id).profile{id:$(uuid)} if data storage eden:database waypoints.hubs.$(waypoint_id){access:"private"} run \
    item modify block ~ ~ ~ container.$(slot) [\
        {"function":"minecraft:set_name","entity":"this","target":"custom_name","name":{"nbt":"waypoints.hubs.$(waypoint_id).waypoint_name","storage":"eden:database","bold":false,"italic":false}},\
        {"function":"minecraft:set_lore","entity":"this","lore":[\
            [{"translate":"gui.warping_wonders.waypoint_hub.access","color":"dark_gray","bold":false,"italic":false},{"translate":"gui.warping_wonders.waypoint_hub.private","color":"red","bold":false,"italic":false}],\
            [{"text":"  "}],\
            [{"translate":"gui.warping_wonders.waypoint_hub.owner","color":"dark_gray","bold":false,"italic":false},{"nbt":"waypoints.hubs.$(waypoint_id).profile.name","storage":"eden:database","color":"white","bold":false,"italic":false},{"text":" | ID: ","color":"dark_gray","bold":false,"italic":false},{"nbt":"waypoints.hubs.$(waypoint_id).id","storage":"eden:database","color":"white","bold":false,"italic":false}],\
                ],"mode":"replace_all"}]
