...
$execute if data storage eden:waypoint_db waypoints.$(waypoint_id).gui{page: $(page)} if data storage eden:waypoint_db waypoints.$(waypoint_id).gui{slot: $(slot)} run data modify storage eden:waypoint_tp waypoints.$(gui_id).slot.$(slot).name set from storage eden:waypoint_db waypoints.$(waypoint_id).waypoint_name
