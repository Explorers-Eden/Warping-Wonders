...
$execute at @s unless predicate eden:entity/is_riding in $(dimension) positioned $(x) $(y) $(z) run tp @s ~ ~.5 ~1
$execute at @s if predicate eden:entity/is_riding in $(dimension) positioned $(x) $(y) $(z) run tp @n[type=#eden:is_mount,nbt={Saddle:1b}] ~ ~.5 ~1
