...
execute unless items entity @s weapon.mainhand minecraft:name_tag[minecraft:custom_name] run return run function wawo:waypoint_hub/interaction/right_click/increase_count with storage eden:temp waypoint.head
