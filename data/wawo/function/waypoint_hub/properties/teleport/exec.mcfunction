...
function wawo:waypoint_hub/properties/teleport/get_data with storage eden:temp waypoint.teleport
function wawo:waypoint_hub/properties/teleport/check_pos with storage eden:temp waypoint.teleport